...
class _MyStudentsScreenState extends State<MyStudentsScreen> {
  ...
  Future<void> _loadStudents() async {
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          _students = students;
          _filteredStudents = students; // Inicializar lista filtrada
          _isLoading = false;
        });
      }
    } catch (e) {
  ...
  Future<void> _showNoticeForm() async {
    ...
    // Obter nome do personal
    final userData = await AuthService.getCurrentUserData();
    final trainerName = userData?['nome'] ?? 'Personal Trainer';
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                ...
                style:
                    ElevatedButton.styleFrom(backgroundColor: trainerPrimary),
      ...
      child: Scaffold(
        ...
        body: TabBarView(
          children: [
                    ...
                    : Column(
                        children: [
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                Icon(Icons.people, color: trainerPrimary),
                                const SizedBox(width: 12),
                                Text(
                                  '${_students.length} aluno(s) com fichas',
                                  style: GoogleFonts.lato(
                                    fontSize: 16,
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    '${student['workout_count'] ?? 0} ficha(s)',
                                                    style: GoogleFonts.lato(
                                                      fontSize: 12,
            ...
            // ABA 2: AVISOS
            SentNoticesList(baseColor: trainerPrimary),
          ],
        ),
