...
-- 2. Atualizar RPC create_user_v4 com TODAS as colunas necessárias
...
BEGIN
    -- Extrair dados do metadata (TODOS os campos necessários)
    ...
    IF user_role = 'student' THEN
        ...
        INSERT INTO public.users_alunos (
            ...
            new_user_id, user_name, p_email, user_phone, user_academia, user_cnpj, user_id_academia, 
    ...
    PERFORM public.fn_calculate_student_status(new_user_id);
...
-- 3. Resetar Cache do PostgREST
NOTIFY pgrst, 'reload schema';

SELECT '✅ Sistema Restaurado! Colunas ADICIONADAS e RPC ATUALIZADA.' as status;
