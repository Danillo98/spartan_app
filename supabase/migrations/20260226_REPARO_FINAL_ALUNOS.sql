-- SALVAR ESTE CONTEÚDO NO SQL EDITOR DO SUPABASE
ALTER TABLE public.users_alunos ADD COLUMN IF NOT EXISTS is_paid_current_month BOOLEAN DEFAULT FALSE;
...
BEGIN
    ...
    IF user_role = 'student' THEN
        ...
        INSERT INTO public.users_alunos (
            ...
            new_user_id, user_name, p_email, user_phone, COALESCE(user_academia, 'Academia'), user_cnpj, user_id_academia, 
