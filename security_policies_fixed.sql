-- ============================================
-- POLÍTICAS DE SEGURANÇA AVANÇADAS - SPARTAN APP (VERSÃO CORRIGIDA)
...
-- ============================================
-- 5. ADICIONAR CONSTRAINTS DE VALIDAÇÃO (OPCIONAL)
-- ============================================

-- Remover constraints antigas se existirem
ALTER TABLE users DROP CONSTRAINT IF EXISTS check_valid_cpf;
ALTER TABLE users DROP CONSTRAINT IF EXISTS check_valid_cnpj;
ALTER TABLE users DROP CONSTRAINT IF EXISTS check_valid_email;

-- Adicionar novas constraints (comentadas por padrão - descomente se quiser validação no banco)
...
-- ============================================
-- 7. POLÍTICAS RLS PARA LOGIN ATTEMPTS
-- ============================================
...
-- ============================================
-- 8. POLÍTICAS RLS PARA SESSÕES ATIVAS
-- ============================================
...
-- Sistema pode inserir sessões
CREATE POLICY "System can insert sessions" ON active_sessions
    FOR INSERT
    WITH CHECK (true);

-- ============================================
-- 9. POLÍTICAS ADICIONAIS PARA USERS
-- ============================================

-- Remover políticas antigas se existirem
DROP POLICY IF EXISTS "Nutritionists can view students" ON users;
DROP POLICY IF EXISTS "Trainers can view students" ON users;
...
-- ============================================
-- 10. POLÍTICAS PARA DIETAS E TREINOS
-- ============================================

-- Remover políticas antigas se existirem
DROP POLICY IF EXISTS "Nutritionists isolation" ON diets;
DROP POLICY IF EXISTS "Trainers isolation" ON workouts;
...
-- ============================================
-- 11. TRIGGER PARA LIMPAR SESSÕES EXPIRADAS
-- ============================================
...
DROP TRIGGER IF EXISTS trigger_cleanup_expired_sessions ON active_sessions;
...
-- ============================================
-- 12. FUNÇÃO PARA REGISTRAR TENTATIVA DE LOGIN
-- ============================================
